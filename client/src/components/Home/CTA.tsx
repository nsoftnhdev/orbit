            ...
            <div className="max-w-6xl mx-auto px-5 sm:px-8">
                ...
                >
                    ...
                    <div className="relative">
                        <div className="mb-6 inline-flex items-center gap-1.5 bg-pink-500/10 border border-pink-500/15 text-sky-500 text-[11px] font-medium tracking-[0.06em] uppercase px-3.5 py-1.5 rounded-full">Ready to grow?</div>
                        <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl leading-tight font-medium text-gray-900">
                            Automate your social
                            <br />
                            <span className="text-sky-400 italic">media today</span>
                        </h2>
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
                            <Link to="/login" className="bg-pink-500 text-white rounded-full font-semibold hover:bg-pink-600 hover:shadow-[0_8px_24px_rgba(239,68,68,0.35)] inline-flex items-center gap-2 text-[15px] px-10 py-4 w-full sm:w-auto justify-center">
